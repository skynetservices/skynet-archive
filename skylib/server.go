...
func NewRpcServer(provision interface{}) *RpcServer {
	////star_name := reflect.TypeOf(provision).String())
	type_name := reflect.Indirect(reflect.ValueOf(provision)).Type().Name()
